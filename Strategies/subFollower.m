classdef subFollower < handle
    %Only use as substrat to follower
    ...
    properties
        ...
        % Strategy Specific
        whatToPlay = 0; % Filled in by Follower
        
    end
    
    methods
        function obj = subFollower(n_actions, ID, n_players, varargin)
